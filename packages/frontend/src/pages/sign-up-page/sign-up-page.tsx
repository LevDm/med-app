...
export const SignUpPage = () => {
  ...
  const { signUpUser, isLoading } = useSignUpRequest({
    ...
    onError: (error) => {
      if (error === 'Invalid inviteId') {
        enqueueSnackbar({ variant: 'error', message: 'Приглашение недействительно' });
      }
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                ...
                <Select labelId="gender" {...register('gender')} label="Gender" required fullWidth>
